      ...
      <div className="overlap-wrapper">
        <div className="overlap">
                ...
                <div className="menus">
                  <div className="div-s-card-text-wrapper">
                    <div className="div-s-card-text">
                      <div className="div">
                        <div className="text-wrapper-2">Main Clinic</div>
                        <div className="div-wrapper">
                          <p className="p">
                            120 Maginhawa Street, Teachers Village, Diliman Quezon City Room 1013 South, Tower,
                            Cathedral Heights Bldg. Complex, E. Rodriguez Ave. Unit 201 BMCI Building 3, 1146 Hermosa
                            Street Abad Santos, Manila., Quezon City, Philippines
                          </p>
                        </div>
                      </div>
                      <div className="frame-2">
                        <div className="text-wrapper-2">Our Hotline</div>
                        <div className="div-wrapper">
                          <div className="text-wrapper-3">0917 828 0047</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="overlap-group-2">
            <img className="ellipse-2" alt="Ellipse" src="ellipse.svg" />
